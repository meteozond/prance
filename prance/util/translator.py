...
class RefTranslator:
    """
    Resolve JSON pointers/references in a spec by copying them to /components/schemas
    object of the root document, translating the references to their new location.
    """
    ...
    def translate_references(self):
        """
        Iterate over the specification document, performing the translation. Then add
        the collected reference from external files to /components/schemas.
        """
